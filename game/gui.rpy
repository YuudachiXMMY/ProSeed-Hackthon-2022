...
## 为“0.5”来放置到正中。
define gui.dialogue_xpos = 269
define gui.dialogue_ypos = 51

## 对话文本的最大宽度（以像素为单位）。
define gui.dialogue_width = 747
...
define gui.radio_button_borders = Borders(19, 5, 5, 5)

define gui.check_button_borders = Borders(19, 5, 5, 5)
...
define gui.choice_button_width = 793
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(101, 6, 101, 6)
...
## 存档位按钮。
define gui.slot_button_width = 277
define gui.slot_button_height = 207
...
## 存档所用缩略图的宽度和高度。
define config.thumbnail_width = 257
define config.thumbnail_height = 145
...
## 导航按钮左侧相对于屏幕左侧的位置。
define gui.navigation_xpos = 41

## 快进指示器的垂直位置。
define gui.skip_ypos = 11

## 通知界面的垂直位置。
define gui.notify_ypos = 46

## 菜单选项之间的间距。
define gui.choice_spacing = 23
...
## 用作确认界面部分的框架。
define gui.confirm_frame_borders = Borders(41, 41, 41, 41)

## 用作快进界面部分的框架。
define gui.skip_frame_borders = Borders(17, 6, 51, 6)

## 用作通知界面部分的框架。
define gui.notify_frame_borders = Borders(17, 6, 41, 6)
...
define gui.history_height = 141

## 所指定叙述角色的标签的坐标、宽度和对齐方式。
define gui.history_name_xpos = 156
define gui.history_name_ypos = 0
define gui.history_name_width = 156
define gui.history_name_xalign = 1.0

## 对话文本的坐标、宽度和对齐方式。
define gui.history_text_xpos = 171
define gui.history_text_ypos = 3
define gui.history_text_width = 743
...
## NVL 模式背景窗口的背景边框。
define gui.nvl_borders = Borders(0, 11, 0, 21)
...
## 所指定叙述角色的标签的坐标、宽度和对齐方式。
define gui.nvl_name_xpos = 432
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 151
define gui.nvl_name_xalign = 1.0

## 对话文本的坐标、宽度和对齐方式。
define gui.nvl_text_xpos = 452
define gui.nvl_text_ypos = 9
define gui.nvl_text_width = 592
define gui.nvl_text_xalign = 0.0

## nvl_thought 文本（由 nvl_narrator 字符表示的文本）的位置，宽度和对齐方式。
define gui.nvl_thought_xpos = 241
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 783
define gui.nvl_thought_xalign = 0.0

## NVL menu_buttons 的位置。
define gui.nvl_button_xpos = 452
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(41, 15, 41, 0)
    ...
    def small():
        ...
        ## 字体大小。
        gui.text_size = 31
        gui.name_text_size = 37
        gui.notify_text_size = 26
        gui.interface_text_size = 31
        gui.button_text_size = 31
        gui.label_text_size = 35

        ## 调整对话框的位置。
        gui.textbox_height = 241
        gui.name_xpos = 81
        gui.dialogue_xpos = 91
        gui.dialogue_width = 1104

        ## 更改各元素的尺寸和间距。
        gui.slider_size = 37

        gui.choice_button_width = 1244
        gui.choice_button_text_size = 31

        gui.navigation_spacing = 21
        gui.pref_button_spacing = 11

        gui.history_height = 191
        gui.history_text_width = 693
        ...
        gui.nvl_name_width = 306
        gui.nvl_name_xpos = 327

        gui.nvl_text_width = 918
        gui.nvl_text_xpos = 347
        gui.nvl_text_ypos = 6

        gui.nvl_thought_width = 1244
        gui.nvl_thought_xpos = 21

        gui.nvl_button_width = 1244
        gui.nvl_button_xpos = 21
