...
public class MarvelParser {
     ...
     * @return an Iterator iterating the dataset in the .tsv file
     */
    public static Iterator<CharacterInfo> parseData(String filename) {
        ...
        Iterator<CharacterInfo> resultIterator = new CsvToBeanBuilder<CharacterInfo>(reader) // set input
                        .withType(CharacterInfo.class) // set entry type
                        .withSeparator('\t')
