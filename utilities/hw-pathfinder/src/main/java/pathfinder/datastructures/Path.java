...
/**
 * This represents an immutable path between two cartesian coordinate points Es, particularly
...
public class Path<E> implements Iterable<Path<E>.Segment> {
    ...
    // AF(this) =
    //      first point E in the path => start
    //      each "step" along the path between points => elements of list path, where
    //          path.get(0) is the first step from the start point E to an intermediate point E, and
    //          path.get(path.size() - 1) is the final step from an intermediate point E to the end
    //      total cost along the path => cost
    //      the destination point E in this path, opposite the start point E => getEnd()
    ...
    /**
     * The point E at the beginning of this path.
     */
    private E start;
    ...
    /**
     * Creates a new, empty path containing a start point E. Essentially this represents a path
     * from the start point E to itself with a total cost of "0".
     *
     * @param start The starting point E of the path.
     */
    public Path(E start) {
        this.start = start;
        this.cost = 0;
    ...
    /**
     * Appends a new single segment to the end of this path, originating at the current last point E
     ...
     * segmentCost}.
     *
     * @param newEnd      The point E being added at the end of the segment being appended to this path
    ...
    /**
     * @return The point E at the beginning of this path.
     */
    public E getStart() {
        return start;
    }
    ...
    /**
     * @return The point E at the end of this path, which may be the start point E if this path
     * contains no segments (i.e. this path is from the start point E to itself).
     */
    public E getEnd() {
        if(path.size() == 0) {
            return start;
     ...
     * point E and ending at the end point E. In the case that this path represents a path between
     * the start point E and itself, this iterator contains no elements. This iterator does not
    ...
    public Iterator<Segment> iterator() {
        ...
        return new Iterator<Path<E>.Segment>() {
     ...
     * both paths are empty, they are only equal if their starting point E is equal.
     *
    ...
    public class Segment {
         ...
         *
         * @param start The starting point E of this segment.
         * @param end   The ending point E of this segment.
        ...
        /**
         * @return The beginning point E of this segment.
         */
        public E getStart() {
        ...
        /**
         * @return The ending point E of this segment.
         */
        public E getEnd() {
            return this.end;
        }
